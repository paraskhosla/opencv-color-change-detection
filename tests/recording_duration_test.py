...
# Global variable to store the duration of the recorded video
duration = 0
...
# # Allows data to be published with a predefined structure.
# def create_document(title, duration, color_changes_detected, filepath, pHData, tempData, humData):
#     duration = main()
...
#     "icon_name": "fa-play",
#         "color_changes_detected": color_changes_detected,
#         "filepath": filepath,
#     "pH": [
#     {
#         "series": ["X"],
...
def main():
    ...
    while True:
        ...
        if time.time() - no_color_change_start_time >= 120:
    ...
    if recording_start_time is not None:
        duration_seconds = time.time() - recording_start_time
